    ...
    for (i = 0; i < keys.length; i++) {
        ...
        for (j = 0; j < pair1.length; j++) {
            for (k = 0; k < pair2.length; k++) {
                ...
                if (indexPair[0] == indexPair[1] || indexPair[1] == indexPair[2] || indexPair[2] == indexPair[3]) continue;
